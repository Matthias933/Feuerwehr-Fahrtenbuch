...
import 'package:fahrtenbuch_frontend/util/dropdown_input.dart';
   ...
   void filterRides() {
    ...
    setState(() {
      filteredRides = rideManagement.rides.where((ride) {
        ...
        // Check car filter
        bool matchesCar = selectedCar == null || ride.Vehicle!.CarNumber == selectedCar;

        return matchesStart && matchesEnd && matchesCar;
      }).toList();
    });
  }
